...
if (isset($_POST['simpan']))
{
	...
	{
		$koneksi->query("UPDATE akun SET nama='$_POST[nama]', username='$_POST[username]', password='$_POST[password]' WHERE id_akun='$_GET[id]'");
...
<div class="form-group">
	...
	<input readonly="" type="text" name="username" class="form-control" value="<?php echo $detail['username']; ?>">
</div>
<div class="form-group">
	<label>Password</label>
	<input readonly="" type="password" name="password" class="form-control" value="<?php echo $detail['password']; ?>">
</div>
<div class="form-group">
	<label>Foto</label><br>
